...
module.exports = {
	...
	async execute(client,message,args){
        ...
        if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            return msg.channel.send(embed.setDescription(`<:yes:591629527571234819>  **|**  Playlist: **\`${playlist.title}\`** has been added to the queue!`));
        } else {
            try {
...
Please provide a value to select one of the search results ranging from 1-10.
                    ...
                    try {
                        ...
                        console.error(err);
                        return msg.channel.send(embed.setDescription("<a:error:854851816289075260> | No or invalid value entered, cancelling video selection..."));
                    }
